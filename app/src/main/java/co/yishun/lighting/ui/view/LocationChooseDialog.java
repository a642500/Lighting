...
public class LocationChooseDialog extends MaterialDialog {
    ...
    protected LocationChooseDialog(final Builder builder) {
        super(builder);

        View dialogView = getCustomView();
        assert dialogView != null;
        final Spinner provinceSpinner = (Spinner) dialogView.findViewById(R.id.provinceSpinner);
        final Spinner districtSpinner = (Spinner) dialogView.findViewById(R.id.districtSpinner);
